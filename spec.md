...
| [spec/data_model.md](spec/data_model.md) | 16 таблиц, соглашения хранения, репозиторий, экспорт, удаление | `src/db/models.py`, `src/db/repo.py`, `src/export.py` |
| [spec/llm.md](spec/llm.md) | протокол клиента, OpenRouter, mock, разбор JSON | `src/llm/*` |
| [spec/ingest.md](spec/ingest.md) | маршрутизация ввода, промпты, распознавание, текст, единицы, PDF | `src/vision/*`, `src/ingest/*` |
