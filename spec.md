...
| [spec/onboarding.md](spec/onboarding.md) | анкета о целях и теле при первом запуске, каталог целей | `src/handlers/onboarding.py`, `src/handlers/goals.py`, `src/goals.py` |
